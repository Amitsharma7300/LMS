  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-section-height -z-1 bg bg-gradient-to-b from-cyan-100/70">
          {" "}
        </div>
        {/* Left column */}
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            ...
            <p className="text-blue-600">
              ...
              {courseData.ratingsCount > 1 ? "ratings" : "rating"})
            </p>
            <p>
          ...
          <p className="text-sm">
            Course by
            <span className="text-blue-600 underline"> Amit Sharma</span>
          </p>
...
alt="timeLeft"/>
            ...
            <div className="flex items-center gap-3 pt-2">
              <p className=" font-semibold text-gray-800 md:text-4xl text-2xl">
                {currency}{" "}
                {(
