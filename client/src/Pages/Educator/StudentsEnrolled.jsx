...
<td className="px-4 py-3 text-center sm: table-cell-hidden">{index +
...
<td className="px-4 py-3 sm: table-cell-hidden">{new Date(item.purchaseDate).toLocaleDateString()}</td>
