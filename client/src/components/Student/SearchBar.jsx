...
const SearchBar = ({data}) => {
  ...
  return (
     ...
     <form  onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-11 flex items-center bg-white
     border border-gray-500/20 rounded'>
      <img src={assets.search_icon} alt="Search icon" className='md:auto w-10 x-3 ' />
